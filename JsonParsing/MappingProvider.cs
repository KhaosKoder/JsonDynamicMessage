...
public static class MappingProvider
{
    public static List<Mapping> GetMappings()
    {
        var mappings = new List<Mapping>
        {
            ...
            new Mapping(id: 14, name: "Contact", jsonPath: "$.Person.Contact", type: typeof(object), nestedMappings: new List<Mapping>
            {
                new  Mapping(id: 15, name: "Email", jsonPath: "$.Email", type: typeof(string))
            }),
